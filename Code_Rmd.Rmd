...
Now we will see if being a colonizer is correlated with having high degree centrality.
...
Being in the case of a directed graph, supposing also that a country with many trade edges has thus a powerful currency, and so powerful countries should attract a lot of less powerful countries to them. To find these clusters of powerful currency countries, countries with low money power and maybe a third class of in-between countries, we will use multiple clustering methods, and compare their results to choose the best number of communities.
